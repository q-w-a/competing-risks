...
saveRDS(list(sim_res_scenario_1, estimated), here("results/scenario_1_results.RDS"))
...
plt_scenario_1 <- estimated %>%
  ...
  geom_hline( linetype=2,
             aes(color="True Total Treatment Effect", 
...
saveRDS(list(sim_res_scenario_2, estimated), here("results/scenario_2_results.RDS"))
...
saveRDS(plt_scenario_2, here("results/plt_scenario_2.RDS"))
...
saveRDS(list(sim_res_scenario_3, estimated), here("results/scenario_3_results.RDS"))
...
saveRDS(plt_scenario_3, here("results/plt_scenario_3.RDS"))
...
estimated <- map2_df(sim_res_scenario_4,
                     SAMPLE_SIZES,
                    ~ {
                      gformula_estimation(.x) %>%
                        mutate(n=.y)
...
saveRDS(list(sim_res_scenario_4, estimated), here("results/scenario_4_results.RDS"))
...
saveRDS(plt_scenario_4, here("results/plt_scenario_4.RDS"))
...
```{r plot-4-together, fig.height=8, fig.width=8}

plt_scenario_1 <- readRDS(here("results/plt_scenario_1.RDS"))
plt_scenario_2 <- readRDS(here("results/plt_scenario_2.RDS"))
plt_scenario_3 <- readRDS(here("results/plt_scenario_3.RDS"))
plt_scenario_4 <- readRDS(here("results/plt_scenario_4.RDS"))
...
plot_grid(panel_1, panel_2, nrow=2, rel_heights=c(0.1, .95))

ggsave(here("figure/figure_1.jpeg"))
