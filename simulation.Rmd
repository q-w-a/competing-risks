...
# first L is L_0, next is L_1
# e.g. L1_L0 indicates L_0=1, L_1=0
A1_L1_L0_P_Y_K1 <- A1_L1_P_Y + .06
A1_L0_L0_P_Y_K1 <- A1_L0_P_Y + .03
A1_L0_L1_P_Y_K1 <- A0_L0_P_Y + .1
A1_L1_L1_P_Y_K1 <- A0_L1_P_Y + .2

A0_L1_L0_P_Y_K1 <- A1_L1_P_Y + .08
A0_L0_L0_P_Y_K1 <- A1_L0_P_Y + .03
A0_L0_L1_P_Y_K1 <- A0_L0_P_Y + .05
A0_L1_L1_P_Y_K1 <- A0_L1_P_Y + .1
...
result <- gformula(obs_data = sim_dat_formatted_dt,
                    ...
                    basecovs = c('A'),
                    covtypes=c('binary'),
                    covparams = list(covmodels = c(L ~ A + lag1_L)),
                    histvars = list(c('L')),
                    histories = c(lagged),
                    # treatment is not time-varying
                    # basecovs = 'A',
...
# L0 = 1
EY_A0 <-
  A0_L1_P_Y * (1-A0_L1_P_D) * .5 +
# L0 = 0
  A0_L0_P_Y * (1-A0_L0_P_D) * .5 +
## K = 1
# L0 = 0, L1 = 0
  A0_L0_L0_P_Y_K1 * (1-A0_L0_L0_P_D_K1) * (1-L1_GIVEN_L0_P) +
# L0 = 1, L1 = 1
  A0_L1_L1_P_Y_K1 * (1-A0_L1_L1_P_D_K1) * (L1_GIVEN_L0_P) +
# L0 = 0, L1 = 1
  A0_L0_L1_P_Y_K1 * (1-A0_L0_L1_P_D_K1) * (L1_GIVEN_L1_P) +
# L0 = 1, L1 = 0
  A0_L1_L0_P_Y_K1 * (1-A0_L1_L0_P_D_K1) * (1-L1_GIVEN_L1_P) 
...
## K = 1
# L0 = 0, L1 = 0
  A1_L0_L0_P_Y_K1 * (1-A1_L0_L0_P_D_K1) * (1-L1_GIVEN_L0_P) +
# L0 = 1, L1 = 1
  A1_L1_L1_P_Y_K1 * (1-A1_L1_L1_P_D_K1) * (L1_GIVEN_L0_P) +
# L0 = 0, L1 = 1
  A1_L0_L1_P_Y_K1 * (1-A1_L0_L1_P_D_K1) * (L1_GIVEN_L1_P) +
# L0 = 1, L1 = 0
  A1_L1_L0_P_Y_K1 * (1-A1_L1_L0_P_D_K1) * (1-L1_GIVEN_L1_P) 
